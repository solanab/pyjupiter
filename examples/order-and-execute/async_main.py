...
async def main():
    ...
    logger.info(f"Wallet address: {await client.get_public_key()}")
    ...
    try:
        ...
        order_response = await client.order(order_request)
        ...
        logger.info("Order and Execute API Response (Async):")
